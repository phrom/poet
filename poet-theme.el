...
(let ((fg "#444444")
 ...
 (custom-theme-set-faces 'poet
  ...
  `(mode-line ((t (:inherit fixed-pitch :foreground ,mode-line-fg :background ,mode-line-bg :overline ,sep :box (:line-width 3 :color ,mode-line-bg)))))
  ...
  `(mode-line-inactive ((t (:inherit mode-line :background ,mode-line-inactive-bg :foreground ,mode-line-inactive :box (:color ,mode-line-inactive-bg :line-width 3)))))
  ...
  `(org-done ((t (:inherit fixed-pitch :height (lambda (_x) (poet-theme--height 1)) :foreground ,org-done))))
  `(org-todo ((t (:inherit fixed-pitch :height (lambda (_x) (poet-theme--height 1)) :foreground ,org-todo))))
  `(org-tag ((t (:inherit default :height (lambda (_x) (poet-theme--height 1)) :foreground ,org-tag))))
  `(org-block-begin-line ((t (:inherit fixed-pitch :background ,org-block-line :extend t))))
  `(org-block-end-line ((t (:inherit fixed-pitch :background ,org-block-line :extend t))))
  `(org-block ((t (:background ,org-block-bg :inherit fixed-pitch :extend t))))
